...
4. [Frequent Elements in The Array](Frequent_Elements_In_The_Array.java)
5. [Sort Game](Sort_Game.java)
6. [Find Kth Largest Number](Find_Kth_Largest_Number.java)
7. [Merge K Sorted Lists](Merge_K_Sorted_List.java)
8. [Merge K Sorted Arrays](Merge_K_Sorted_Arrays.java)
